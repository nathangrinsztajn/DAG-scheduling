...
class DAGEnv(gym.Env):
    def __init__(self, n, max_in, max_out, node_types, window, noise=False):
    ...
    def reset(self):
        ...
        self.n = self.task_data.num_nodes
        self.time = 0
        self.num_steps = 0
        ...
        # compute inital doable tasks

        new_ready_tasks = torch.arange(0, self.n)[torch.logical_not(isin(torch.arange(0, self.n), self.task_data.edge_index[1, :]))]
