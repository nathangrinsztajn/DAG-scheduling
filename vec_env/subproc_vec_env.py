...
from vec_env.base_vec_env import VecEnv, CloudpickleWrapper
...
class SubprocVecEnv(VecEnv):
    ...
    def __init__(self, env_fns, start_method=None, stack_observations=False):
        self.waiting = False
        self.closed = False
        self.stack_observation = stack_observations
        n_envs = len(env_fns)
